...
|idinaloq|Erick|
|:------:|:------:|
|[Github Profile](https://github.com/idinaloq)|[Github Profile](https://github.com/h-suo)|
|<img src="https://user-images.githubusercontent.com/109963294/235301015-b81055d2-8618-433c-b680-58b6a38047d9.png" height="300"/>|<img src="https://user-images.githubusercontent.com/109963294/235300758-fe15d3c5-e312-41dd-a9dd-d61e0ab354cf.png" height="300"/>|
...
- PR 요구사항에 맞게 코드 수정
- 메뉴선택 함수 추가 및 사용자에게 값을 입력 받는 함수 추가

### 4월 27일(목)
- 입력받은 값을 조건과 비교하는 함수 추가
- 새로 추가된 함수에 맞게 두 수를 비교하는 함수 수정
- 시작함수에 메뉴선택 함수가 호출되도록 수정
- Pull Request 생성
